...
void Config::init() {
    ...
    printf("Gyro calibration:  (%f, %f, %f)", mpu_calibration.gyro[0], mpu_calibration.gyro[1], mpu_calibration.gyro[2]);
    printf("Accel calibration: (%f, %f, %f)", mpu_calibration.accel[0], mpu_calibration.accel[1], mpu_calibration.accel[2]);
